...
const LABELS: Record<string, string> = {
  ...
  process: "תהליך",
  business: "Google Business / SEO מקומי",
  contact: "יצירת קשר",
  footer: "כותרת תחתונה",
  ...
  streetAddress: "רחוב ומספר (כתובת מלאה)",
  postalCode: "מיקוד",
  addressRegion: "מחוז / אזור",
  latitude: "קו רוחב (Latitude)",
  longitude: "קו אורך (Longitude)",
  googleMapsUrl: "קישור Google Maps (Share link)",
  sameAs: "רשתות חברתיות (sameAs)",
  openingHours: "שעות פעילות",
  days: "ימים (Monday, Tuesday...)",
  opens: "שעת פתיחה (09:00)",
  closes: "שעת סגירה (18:00)",
  instagram: "Instagram",
  linkedin: "LinkedIn",
  facebook: "Facebook",
  pinterest: "Pinterest",
